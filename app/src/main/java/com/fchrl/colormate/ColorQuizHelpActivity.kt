...
import com.fchrl.colormate.databinding.ActivityColorQuizHelpBinding

class ColorQuizHelpActivity : AppCompatActivity() {
    private lateinit var binding: ActivityColorQuizHelpBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityColorQuizHelpBinding.inflate(layoutInflater)
